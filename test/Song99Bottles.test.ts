...
describe('99 bottles', function (): void {
    ...
    // it('should return right nounssingular starting from 1', function (): void {
    //     const result: string[] = Song99BottlesClass.song(1,1);
    //     const expectedResut = [
    ...
    // it('should return right nounssingular starting from 0', function (): void {
    //     const result: string[] = Song99BottlesClass.song(0,1);
    //     const expectedResut = [
    ...
    it('should return complete song', function() {
        const result: string[] = Song99BottlesClass.song(99,100);
